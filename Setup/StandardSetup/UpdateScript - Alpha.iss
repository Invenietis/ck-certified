...
AppId={{883E572C-BF2A-4C0D-8906-E14966EFF067}}
...
[Icons]
Name: "{group}\CiviKey (alpha)"; Filename: "{app}\binaries\CiviKey.exe"; WorkingDir: "{app}"; IconFileName:"{app}\resources\CiviKey.ico";
Name: "{commondesktop}\CiviKey (alpha)"; Filename: "{app}\binaries\CiviKey.exe"; WorkingDir: "{app}"; IconFileName:"{app}\resources\CiviKey.ico"
