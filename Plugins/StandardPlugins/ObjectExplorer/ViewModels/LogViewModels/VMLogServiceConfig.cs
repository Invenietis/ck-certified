...
namespace CK.StandardPlugins.ObjectExplorer.ViewModels.LogViewModels
{
    public class VMLogServiceConfig : VMLogBaseElement, ILogServiceConfig
    {
            ...
            : base(name, isBound)
        {
            ...
            _methodsEx = new ReadOnlyCollectionTypeAdapter<ILogMethodConfig, VMLogMethodConfig>(_methods);

            _events = new ObservableCollection<VMLogEventConfig>();
            _eventsEx = new ReadOnlyCollectionTypeAdapter<ILogEventConfig, VMLogEventConfig>(_events);

            _properties = new ObservableCollection<VMLogPropertyConfig>();
            _propertiesEx = new ReadOnlyCollectionTypeAdapter<ILogPropertyConfig, VMLogPropertyConfig>(_properties);
        }
