...
namespace CK.WPF.ViewModel
{
    ...
    public static class PropertyLookupExtentions
    {
        ...
        public static IEnumerable<object> GetPropertyLookupPath( this IKeyboardElement obj )
        {
            ...
            throw new ArgumentException( "There is no property lookup path available for this type yet", "obj : " + obj.GetType().ToString() );
        }
        ...
        {
            IEnumerable<object> path = obj.GetPropertyLookupPath();
