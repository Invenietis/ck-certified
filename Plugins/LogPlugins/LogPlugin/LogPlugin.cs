...
namespace LogPlugin
{
    ...
    public class LogPlugin : IPlugin, ILogService
    {
        const string PluginIdString = "{FEA8570C-2ECE-44b3-B1CE-0DBA414D5045}";
        const string PluginIdVersion = "1.0.0";
        const string PluginPublicName = "LogPlugin";
        public static readonly INamedVersionedUniqueId PluginId = new SimpleNamedVersionedUniqueId( PluginIdString, PluginIdVersion, PluginPublicName );
        
        static Common.Logging.ILog _log = Common.Logging.LogManager.GetLogger<LogPlugin>();
