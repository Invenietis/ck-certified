...
namespace PointerWatcher
{
    /// <summary>
    /// This plugin watches the MousePointer, and indicates wether is hasn't been moving since a certain period of time (that can be set via <see cref="TimeBeforeCountDownStarts"/>).
