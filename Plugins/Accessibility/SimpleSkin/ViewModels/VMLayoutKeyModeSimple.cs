...
namespace SimpleSkin.ViewModels
{
    ...
    /// </summary>
    internal class VMLayoutKeyModeSimple : VMLayoutKeyMode<VMContextSimple, VMKeyboardSimple, VMZoneSimple, VMKeySimple, VMKeyModeSimple, VMLayoutKeyModeSimple>
    {
        public VMLayoutKeyModeSimple( VMContextSimple ctx, ILayoutKeyMode layoutKeyMode )
            : base( ctx, layoutKeyMode )
        {
