...
C:\Code\Dev4\Git-CK-Certified>@git.exe %*
...
begin
    ...
    then begin
        ...
        if(MsgBox('CiviKey n�cessite le Framework .NET 4.0 Client Profile.'#13#13'Cliquez sur "Non" pour annuler l''installation ou "Oui" pour t�l�charger le Framework .NET 4.0 Client Profile automatiquement sur le site de Microsoft.', mbConfirmation, MB_YESNO) = IDYES) 
        then begin 
          ...
          MsgBox('Installation annul�e.', mbInformation, MB_OK);
          Abort;
        end;
	end;
	result := true;
...
C:\Code\Dev4\Git-CK-Certified>@set ErrorLevel=%ErrorLevel%

C:\Code\Dev4\Git-CK-Certified>@rem Restore the original console codepage.

C:\Code\Dev4\Git-CK-Certified>@chcp %cp_oem% > nul < nul
