#region LGPL License
/*----------------------------------------------------------------------------
* This file (StandardPlugins\PointerDeviceDriver\DriverLib\DriverLib.cs) is part of CiviKey. 
*  
...
namespace PointerDeviceDriver
{
    ...
    internal static class Win32Wrapper
    {
        ...
        [DllImport("user32.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
        internal static extern void mouse_event(MouseEventFlags dwFlags, long dx, long dy, long cButtons, long dwExtraInfo);
    ...
    /// </summary>
    [Flags]
    internal enum MouseEventFlags : long
    {
        LEFTDOWN = 0x00000002,
        LEFTUP = 0x00000004,
