...
namespace Host.VM
{
    public class AutoClickViewModel : ConfigPage
    {
        ...
        {
            get { return _acPlugin != null ? _app.IsPluginRunning( _acPlugin.PluginKey ) : false; }
            set
            {
        ...
        protected override void OnInitialize()
        {
            ...
            ConfigItemMillisecondProperty p2 = new ConfigItemMillisecondProperty( ConfigManager, this, Helper.GetPropertyInfo( this, h => h.TimeBeforeCountDownStarts ) );
            p2.DisplayName = R.AutoClickTimeBeforeCountDownStarts;
            g.Items.Add( p2 );

            ConfigItemMillisecondProperty p = new ConfigItemMillisecondProperty( ConfigManager, this, Helper.GetPropertyInfo( this, h => h.CountDownDuration ) );
