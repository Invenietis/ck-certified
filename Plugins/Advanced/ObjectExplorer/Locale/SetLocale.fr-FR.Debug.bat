...
copy %objPath%CK.Plugins.%pluginName%.R.%culture%.resources %outputPath%%tempFolderName%\CK.Plugins.%pluginName%.R.%culture%.resources
)
...
al /template:Plugins\%pluginName%.dll /embed:%tempFolderName%\%pluginName%.g.%culture%.resources /embed:%tempFolderName%\CK.Plugins.%pluginName%.R.%culture%.resources /culture:%culture% /out:Plugins\%culture%\%pluginName%.resources.dll 
