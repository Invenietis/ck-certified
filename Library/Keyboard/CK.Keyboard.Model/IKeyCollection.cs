#region LGPL License
/*----------------------------------------------------------------------------
* This file (Library\Keyboard\CK.Keyboard.Model\IKeyCollection.cs) is part of CiviKey. 
*  
...
namespace CK.Keyboard.Model
{
    ...
    public interface IKeyCollection : ICKReadOnlyList<IKey>
    {
        ...
        IKey Create( int index );
          ...
          /// <summary>
        /// Creates a copy of the specified <see cref="IKey"/>.
        /// The copy is copied in the same <see cref="IZone"/> as the source.
        /// </summary>
