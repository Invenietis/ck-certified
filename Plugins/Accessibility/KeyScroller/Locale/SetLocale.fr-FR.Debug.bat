...
al /template:Plugins\%pluginName%.dll /embed:%tempFolderName%\%pluginName%.g.%culture%.resources /embed:%tempFolderName%\%pluginName%.Resources.R.%culture%.resources /culture:%culture% /out:Plugins\%culture%\%pluginName%.resources.dll 
